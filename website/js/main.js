function move(element, direction, distance) {
    ...
    function moveAFrame() {
       if (parseInt(elStyle.getPropertyValue(topOrLeft))==parseInt(destination)) {
        ...
        onMove = true;
          ...
          value = elStyle.getPropertyValue(topOrLeft).replace("px", "").replace("%", "");
...
searchButton.addEventListener("click",function(){
    setTimeout(function(){if(onMove === false){
