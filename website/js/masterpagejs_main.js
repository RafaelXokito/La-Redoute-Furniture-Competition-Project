...
+(function (n) {
    ...
    (n.DC_Data = {}),
      ...
      (n.Tracking = n.Class.extend({
        init: function (i, r) {
          var o = this,
            e = r.Model,
            y = n._satellite.track,
            p = n.Utils,
            w = n.trackingRule.global,
            b = n.globalTrackingEvent,
            u = {},
            ut = n.globalServiceEvent,
            f = p.StorageManager,
            h = p.Enum.StorageName,
            ...
            d = h.PRODUCT_ORIGIN,
            l = "eVar71",
            c = f.readLocalStorageValue(h.USED_TOOL) || "",
            a = n.Utils.UrlManager.GetHashValue("opeco"),
            ot = f.readLocalStorageValue(h.FLASHSALE_ORIGIN),
            bt = {
            ...
            st = "wa_data",
            ht = !e.isChildProduct && !e.isChildPage,
            g = null,
            ct = 18e5,
            nt,
            rt;
          ...
          var lt = t(n),
            ...
            v = function () {
              pt() ? gt() : yt(), f.createLocalStorageValue(et, +new Date());
            },
            at = function () {
              nt !== undefined && clearTimeout(nt);
            },
            dt = function (t) {
              (o.dataLayer = u = t), (n[st] = u);
            },
            vt = function (t) {
              (n.DC_Data[w.LOYALTY_ADDTOCART] = {
                ProductId: wt,
                Zone: t || "landing",
              }),
                y(w.LOYALTY_ADDTOCART);
            },
            gt = function () {
              f.createLocalStorageValue(k, u.pageName),
                (nt = setTimeout(yt, ct));
            },
            yt = function () {
              f.eraseLocalStorageValue(k);
            },
            pt = function () {
              var n = f.readLocalStorageValue(et);
              return n === null || +new Date() - n < ct;
            },
            ni = function (t) {
              return (
                typeof t === n.varType.str && (t = t.toLowerCase()),
                f.createLocalStorageValue(h.LAST_SEARCH_ID, t)
              );
            },
            it = function (n) {
              return f.createLocalStorageValue(h.SHOPPING_TOOL, n);
            },
            ti = function () {
              var n = {},
                t;
              return (
                n.info || (n.info = {}),
                ft &&
                  (n.datasources = [{ id: bt[r.country], original_id: ft }]),
                ...
                (t = p.CookieManager.ReadCookie("cto_bundle")),
                (n.info.ctoBundleCriteo = t !== null ? t : ""),
                n
              );
            };
          (o.destroy_tracking = function () {
            lt.off("focus", v).off("blur", at);
          }),
            (o.expose_dataLayer = function () {
              v(), (n[st] = u);
            }),
            (o.launchDirectCall = function (t, i) {
              typeof i === n.varType.obj && (n.DC_Data[t] = i), y(t);
            }),
            (o.set_shoppingTool = function (n) {
              (c = tt(n)),
                e.channel === "pdp"
                  ? (o.productOrigin = c)
                  : document.hasFocus() && it(c);
            }),
            (o.set_productOrigin = function (n) {
              return f.createLocalStorageValue(d, tt(n));
            }),
            (o.update_dataLayer = function (n) {
              t.extend(u, n);
            });
          e.$eventContainer
            .on(ut.addToCartSucceeded, function (t, i, r) {
              var e = f.readLocalStorageValue(d),
              ...
              r && (s = r.hasATBlayer),
                ...
                e !== null &&
                  ((u.eVar80 = e), (u.prop60 = e), f.eraseLocalStorageValue(d)),
                r &&
                ...
                o.launchDirectCall(w.PRODUCT_ADDTOCART, u),
                r && r.hasLoyalty && vt(r.componant);
            })
            .on(ut.addLoyaltyToCartSucceeded, function (n, t, i) {
              var r;
              i && (r = i.componant), vt(r);
            })
            .on(b.SHOPPING_TOOL_USED, function (n, t) {
              f.createLocalStorageValue(
                h.USED_TOOL,
                tt({ type: t.type, subType: t.subType, extraData: t.extraData })
              ),
                (t.keyword || t.guidedNavId) && ni(t.keyword || t.guidedNavId),
                t.type === "SEARCH" &&
                  t.extraData.length >= 2 &&
                  (t.extraData[1] === "keyword-autocompletion"
                    ? f.createLocalStorageValue(l, "autocompletion")
                    : t.extraData[1] === "cat-autocompletion"
                    ? f.createLocalStorageValue(l, "cat-autocompletion")
                    : t.extraData[1] === "history"
                    ? f.createLocalStorageValue(l, "search-history")
                    : t.extraData[1] === "internal" &&
                      f.createLocalStorageValue(l, "no-autocompletion"));
            });
          if (ht)
            lt.on("focus", function () {
              v(), e.channel !== "pdp" && it(c);
            }).on("blur", at);
          if (ht) {
            (u = e.isMiniPDP
              ? JSON.parse(t("#miniPDPanalyticsDataLayer").text())
              : JSON.parse(t("#analyticsDataLayer").text())),
              pt() && (g = f.readLocalStorageValue(k)),
              e.customer !== undefined &&
                e.customer.customerNumber !== undefined &&
                (u.eVar6 = u.prop10 = e.customer.customerNumber),
              u.eVar1 && (u.eVar59 = u.eVar1),
              u.eVar6 && (u.eVar77 = u.eVar6),
              g !== null && (u.prop66 = g),
              (u.prop39 = e.isLoggedIn
                ? "islogged"
                : e.isIdentified
                ? "isidentified"
                : "isnotlogged"),
              ot !== null &&
                ((u.eVar72 = ot), f.eraseLocalStorageValue(h.FLASHSALE_ORIGIN)),
              (rt = f.readLocalStorageValue(l)),
              rt && ((u.eVar71 = rt), f.eraseLocalStorageValue(l)),
              document.hasFocus() && v(),
              a
                ? ((a = a.replace(/_/g, "-")),
                  o.set_shoppingTool({
              ...
              e.channel !== "pdp" &&
                (c && o.update_dataLayer({ prop60: c }),
                document.hasFocus() && it(c)),
              (u.prop26 = u.eVar68 = e.siteName),
              e.breadcrumb !== undefined &&
                ((u.prop6 = u.prop7 = u.prop8 = u.prop9 = ""),
                e.breadcrumb.forEach(function (n) {
                  switch (n.level) {
                    case 0:
                      e.pageType !== "SearchPage" &&
              ...
              (u.prop43 = e.isLRAndMe ? "loyaltyprogram" : "notloyaltyprogram"),
            ...
            try {
              n.dispatchEvent && n.CustomEvent
                ? e.$eventContainer[0].dispatchEvent(
            ...
            e.$eventContainer.trigger(b.dataLayerUpdated);
            n.Utils.Common.onEarlyBirdsLoad(function () {
              n._ebq.push(["identify", ti()]);
            });
          }
        },
      }));
  ...
  (_LaRedoute = (function (n, t, i) {
    return {
      ...
      initEvents: function () {
        ...
        var s = Utils.Enum.Form.Input.Email.ValidationRegExp,
          h = i.newsletterInputSelector,
          f = i.newsletterCheckSelector,
          u = i.newsletterMessageClass,
          e = i.newsletterMessageNoCheckClass;
        t("#header,#footer").on("submit", i.newsletterFormSelector, function (
          n
        ) {
          n.preventDefault();
          var r = t(this).find(h).val().trim();
          r != ""
            ? (t(this).find(".block-success").hide(),
              s.test(r) === !0
                ? (t(this).find(f).length > 0 && t(this).find(f).isChecked()) ||
                  t(this).find(f).length === 0
                  ? _LaRedoute.newsletterRegistration(this, r, "footer")
                  : t(this)
                      .find("." + u + "." + e)
                      .show()
                : t(this)
                    .find("." + u + "." + i.newsletterMessageNotEmailClass)
                    .show())
            : t(this)
                .find("." + u + "." + i.newsletterMessageEmptyClass)
                .show();
        });
        ...
        t(f).on("click", function () {
          t("." + u + "." + e).hide(),
            t("." + u + "." + Utils.Enum.Class.BlockInfo.Success).hide();
        });
  ...
  (function (n, t) {
    ...
    (t[i] = function (r, u) {
      ...
      (f.open = function () {
        s ||
          ...
          b.stop().slideDown({
            ...
            complete: function () {
              (o = !1), e.addClass(nt).attr(tt, !0).trigger(dropdownEvent.open);
            },
          }));
      }),
        (f.close = function (n) {
      ...
      h.on("click", function () {
        s ? f.close() : e.hasClass("disabled") || f.open();
      });
      p() && c.addClass(v), rt() && h.append(l);
    }),
      (t.fn[i] = function (n) {
        return this.each(function () {
          var r = t(this),
  ...
  (function (n, t) {
    ...
    n.UiFooter = n.UiBloc.extend({
      init: function (i, r) {
        ...
        u.length > 0 &&
          ((u = JSON.parse(u.text())),
          (c = u.toggleBtnShowText),
          (l = u.toggleBtnHideText));
        var o = t(".footer-services-title"),
          ...
          g = function () {
            h.toggleClass("footer-services-toggleBtn--isToggled"), d(h, c, l);
          },
          nt = function () {
            var n = t("ul.footer-services-content");
            f ? n.slideUp(e) : s ? n.slideDown(e) : p(), (f = k());
          },
          tt = function (n) {
          ...
          p = function () {
            var n = "/servicefooter/loadcolumnsjson.aspx";
            t.ajax({
              cache: !1,
              type: "GET",
              url: n,
        ...
        a.length > 0 && y(a, "BottomSEOKeywords"),
          v.length > 0 && y(v, "BottomSEOSeeAlso");
      },
    });
  })(window, jQuery),
  ...
  (function (n, t) {
    ...
    n.UiLoyaltyLRandME = n.UiBloc.extend({
      init: function (o, s) {
        ...
        if (
          (h._super(o, s),
          t.extend(h, JSON.parse(t("#loyaltyData").text())),
          (h.$container = t("#loyalty")),
          (h.$input = t(r)),
          (h.$conditions = t(i + "-conditions")),
          (h.$details = t(i + "-details")),
          (h.$programTrigger = t(i + "-popin")),
          (h.$subscribe = t(i + "-subscribe")),
          (h.$buttonToBasket = t("." + f)),
          (h.$popinCongrats = t("#popinLRAndMeCongrats")),
          (h.$popinCongratsMessage = t("#popinLRAndMeCongratsMessage")),
          h.Page.name === pageName.pdp)
        )
          h.Model.$eventContainer.on(pdpEvent.articleUpdated, function () {
            h.Model.LRandMe_isAvailable ? h.show() : h.hide();
          });
        if (((h.$inputLoyalty = t(r)), h.$inputLoyalty.length > 0)) {
          t(".loyalty-popin").on("click", function (n) {
            n.preventDefault();
          });
          h.$inputLoyalty.on("click", function () {
            n.Utils.StorageManager.CreateStorageValue(u, this.checked);
          });
          h.Page.name === n.Utils.Enum.PageName.PDP &&
            ((c = n.Utils.StorageManager.ReadStorageValue(u)),
            c && ((t(r)[0].checked = c), (h.shouldAddLoyalty = !0)));
          h.$inputLoyalty.on("change", function () {
            t(this).is(":checked")
              ? ((h.shouldAddLoyalty = !0),
                h.Page.name === n.Utils.Enum.PageName.Basket &&
                  h.AddLoyaltyToCart())
              : (h.shouldAddLoyalty = !1);
          });
        }
        h.$conditions.on("click", function () {
          var n = t(this);
          n.attr("href") || n.attr("href", h.conditionsPdfUrl);
        });
        h.$subscribe.on("click", function (i) {
          i.preventDefault();
          var r = t(this);
          r.feedback(n.Utils.Enum.Feedback.Actions.add),
            h.AddLoyaltyToCart({
              element: r,
              enableAtbLayer: !1,
              enableCongrats: !0,
        ...
        h.$popinCongrats.on("click", h.$buttonToBasket.selector, function () {
          n.location.href = t("#basketIcon").attr("href");
        });
        h.$programTrigger.on("click", function () {
          t("#popinLRAndMeProgram").popin("open");
        });
        h.Model.$eventContainer.on(
          n.globalServiceEvent.addLoyaltyToCartSucceeded,
          function (i, r, s) {
            s &&
              s.fromMainComponent &&
              (n.Utils.StorageManager.EraseStorageValue(u),
              h.Page.name === n.Utils.Enum.PageName.Basket
                ? (t(".loyalty")
                  ...
                  n.location.reload())
                : s.enableCongrats
                ? (h.$popinCongratsMessage.html(
                    r.ResponseMessage.replace(
                      /(panier)/i,
                      '<span class="btn btn-link ' + f + '">$1</span>'
                    )
                  ),
                  r.IsSuccess
                    ? (h.$popinCongratsMessage.removeClass("errorText"),
                      (n.wa_data.prop44 = e))
                    : h.$popinCongratsMessage.addClass("errorText"),
                  h.$popinCongrats.popin("open"))
                : r.IsSuccess && (n.wa_data.prop44 = e),
              o.name === n.Utils.Enum.PageName.PDP &&
                (s
                  ? (s.element &&
                      s.element.feedback(n.Utils.Enum.Feedback.Actions.remove),
                    s.enableAtbLayer && h.Page.AddToBasketSuccessEvent())
                  : h.Page.AddToBasketSuccessEvent()));
          }
        );
        h.Page.name === pageName.pdp &&
          h.Model.LRandMe_isAvailable !== undefined &&
          (h.Model.LRandMe_isAvailable ? h.show() : h.hide());
      },
      AddLoyaltyToCart: function (t) {
        var i = this;
        t === undefined && (t = {}),
          (t.fromMainComponent = !0),
          i.Page.name === n.Utils.Enum.PageName.Basket
            ? (t.componant = "basket")
            : i.Page.name === n.Utils.Enum.PageName.PDP &&
              (t.componant = "pdp"),
          i.Model.$eventContainer.trigger(
      ...
      hide: function () {
        this.$container.hide(), this.$input.prop("checked", !1);
      },
    });
  })(window, jQuery),
  (function (n, t) {
      ...
      init: function (i, r) {
        ...
        function h(n, i, r) {
          ...
          if (
            ...
            i.find(".product").length < 16 && c(n, f, o);
            return;
          }
        ...
        init: function (i, r) {
          ...
          u.applyReco = function (r, u) {
            ...
            (e.store = r.data("type") === "histo" ? "default" : l),
              ...
              (e = t.extend(e, y(r, u))),
              o
                ? (n.eb.ebWidgets.getRecommendations(e, function (
                    u,
                    e,
                    o,
                    l,
          ...
          f.$eventContainer.on(n.EB_landingEvent.menuClicked, function (
            n,
            t,
            i
          ) {
  ...
  (function (n, t) {
    ...
    t[i] = function (r, u) {
        ...
        ((e.open = function () {
          f.url !== undefined && e.isLoaded === !1
            ? (s !== undefined && s.feedback("add"),
              f.preload === !1 && e.shouldBeOpened === !1 && b(),
              (e.shouldBeOpened = !0))
      ...
      if ((o.show(), f.url !== undefined))
        (e.isLoaded = !1), (e.shouldBeOpened = !1), f.preload !== !1 && b();
